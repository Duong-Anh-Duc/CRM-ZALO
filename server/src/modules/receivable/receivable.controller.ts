...
export class ReceivableController {
  ...
  static async delete(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const result = await ReceivableService.delete(req.params.id as string);
      sendSuccess(res, result);
    } catch (err) {
      next(err);
    }
  ...
  static async deletePayment(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const result = await ReceivableService.deletePayment(req.params.paymentId as string);
      sendSuccess(res, result);
    } catch (err) {
      next(err);
    }
